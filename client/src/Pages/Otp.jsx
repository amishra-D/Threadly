...
function Otp() {
  ...
  return (
    <div className="bg-black w-full min-h-screen flex flex-col justify-center items-center px-4 text-white">
      <div className="flex flex-col gap-2 mb-8 max-w-md text-center">
        <h3 className="text-3xl font-semibold">
          OTP has been sent to {email}
          <span className="font-bold text-[#ddff00]"></span>
        </h3>
        <p className="text-lg">
      ...
      <Button className="mt-10 px-6 py-2 text-lg rounded-lg" onClick={handleSubmit}>
        Submit
      </Button>
    </div>
  );
